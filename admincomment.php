...
$locationmemberinfo_result = mysqli_query($con,"SELECT * FROM tblreport_comment JOIN tblmember ON tblreport_comment.member_id=tblmember.member_id JOIN tblvote_comment ON tblreport_comment.location_id=tblvote_comment.location_id
                           WHERE tblreport_comment.vote_comment_id=tblvote_comment.vote_comment_id AND tblreport_comment.member_id=tblmember.member_id ORDER BY reportcomment_id DESC limit {$start} , {$perpage} ");
  ...
  ?>
    ...
    <div class="col-md-8">
      <div class="page-header">
        <h1><i class="far fa-comment" aria-hidden="true"></i> รายงานความคิดเห็นของสมาชิก </h1>
      </div>
      <div>
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              <td><?php echo $i ?></td>
              <td scope="row"><a data-toggle="modal" data-target="#myModal<?php echo $locationmemberinfo["vote_comment_id"];?>"><?php echo $locationmemberinfo["rating_comment"]; ?></a></></td>
              <td scope="row"><?php echo $locationmemberinfo["by_member_name"]; ?> <?php echo $locationmemberinfo["by_member_surname"]; ?></></td>
              <td scope="row">
                <button type="button" class="btn btn-warning" name="button"><a href="report_commentdelete.php?commentid=<?php echo $locationmemberinfo["vote_comment_id"] ?>" onclick="return checkDelete()" style="color:white;">ลบข้อมูล</a></button>
            ...
            <div class="modal fade" id="myModal<?php echo $locationmemberinfo["vote_comment_id"];?>" role="dialog">
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title">ข้อมูลการรายงาน</h4>
                  </div>
                  <div class="modal-body">
                    <p>ข้อความที่ผู้ใช้ <?php echo $locationmemberinfo["by_member_name"];?> <?php echo $locationmemberinfo["by_member_surname"];?> แจ้งเกี่ยวกับความคิดเห็นของ <?php echo $locationmemberinfo["member_name"];?> <?php echo $locationmemberinfo["member_surname"];?></p>
                    <textarea class="form-control" rows="5" name="report_message"><?php echo $locationmemberinfo["reportcomment_message"];?></textarea>
                    <br>
                    <div class="text-center">
        ...
        <?php
        $sql2 = "SELECT * FROM tblreport_comment ORDER BY reportcomment_id DESC";
      ...
      <div class="col-md-12">
        <nav class="text-center">
         <ul class="pagination">
         <li>
         <a href="admincomment.php?page=1" aria-label="Previous">
         <span aria-hidden="true">&laquo;</span>
         </a>
         </li>
         <?php for($i=1;$i<=$total_page;$i++){ ?>
         <li><a href="admincomment.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
         <?php } ?>
         <li>
         <a href="admincomment.php?page=<?php echo $total_page;?>" aria-label="Next">
