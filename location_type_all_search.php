...
$sql_search = "SELECT tbllocation.*,tbllocation_image.*,tblmember.* FROM tbllocation,tbllocation_image,tblmember
WHERE tbllocation.location_id = tbllocation_image.location_id AND tbllocation.member_id = tblmember.member_id
AND tbllocation.location_name /*OR tbllocation.location_info*/ like '%{$search}%'
...
<div class="page-header">
  ...
  <?php
  while($locationmemberinfo = mysqli_fetch_assoc($query)){
    # code...
  ?>
   ...
   ?>
     ...
     <div class="col-md-12">
       <nav class="text-center">
        <ul class="pagination">
        <li>
        <a href="location_type_all_search.php?search=<?php echo $search ?>&page=1" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
        </a>
        </li>
        <?php for($i=1;$i<=$total_page;$i++){ ?>
        <li><a href="location_type_all_search.php?search=<?php echo $search ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
        <?php } ?>
        <li>
        <a href="location_type_all_search.php?search=<?php echo $search ?>&page=<?php echo $total_page;?>" aria-label="Next">
