...
<div class="container marketing">
  <div class="row">
    ...
    <div class="col-lg-4 text-center">
      <img src="img/portfolio/แกะ.png" alt="img-responsive" width="100%">
      <h2 style="text-align: center;">ฟาร์มฮัก</h2>
      <p style="text-align: center;">ฟาร์มแกะและร้านอาหารสไตล์คาวบอย ชื่อว่า Farm Hug สามารถเข้าไปให้เข้าไปให้อาหารได้อย่างใกล้ชิด</p>
      <input type="number" name="your_awesome_parameter" id="rating-readonly" class="rating" data-clearable="remove" value="5" data-readonly/>
      <p><a href="#" class="btn btn-default" role="button">ดูรายละเอียด</a></p>


    </div>
    <div class="col-lg-4 text-center">
      <img src="img/portfolio/ภูพาน.png" alt="img-responsive" width="100%">
      <h2 style="text-align: center;">พระตำหนักภูพาน</h2>
      <p style="text-align: center;">เป็นที่ประทับแรมของพระเจ้าอยู่หัว รัชกาลที่ 9 ใช้เมื่อทรงมาเยี่ยมประชาชนในพื้นที่ภาคอีสาน ตกแต่งแบบเรียบง่าย และใกล้ชิดธรรมชาติ</p>
      <input type="number" name="your_awesome_parameter" id="rating-readonly" class="rating" data-clearable="remove" value="4" data-readonly/>
      <p><a href="#" class="btn btn-default" role="button">ดูรายละเอียด</a></p>

    </div>
    <div class="col-lg-4 text-center">
      <img src="img/portfolio/เกลือ.png" alt="img-responsive" width="100%">
      <h2 style="text-align: center;">หมู่บ้านทำเกลือ</h2>
      <p style="text-align: center;">หมู่บ้านทำเกลือ ตั้งอยู่ที่ อ.วานรนิวาส เป็นสถานที่ทำเกลือจากใต้ดิน ที่ใหญ่ที่สุดในอีสาน</p>
      <input type="number" name="your_awesome_parameter" id="rating-readonly" class="rating" data-clearable="remove" value="3" data-readonly/>
      <p><a href="#" class="btn btn-default" role="button">ดูรายละเอียด</a></p>
...
<ul class="nav nav-tabs" style="color :black;">
  <li class="active"><a data-toggle="tab" href="#home" style="color :black;">แนะนำ</a></li>
  <li><a data-toggle="tab" href="#menu1" style="color :black;">ท่องเที่ยว</a></li>
  <li><a data-toggle="tab" href="#menu2" style="color :black;">สินค้า</a></li>
  <li><a data-toggle="tab" href="#menu3" style="color :black;">บริการ</a></li>
  <li><a data-toggle="tab" href="#menu4" style="color :black;">ร้านอาหาร</a></li>
  <li><a data-toggle="tab" href="#menu5" style="color :black;">ที่พัก</a></li>
  <li><a data-toggle="tab" href="#menu6" style="color :black;">เทศกาล</a></li>
</ul>
