...
$result3 = mysqli_query($con, "SELECT * FROM board ORDER BY rand() LIMIT 10");
  ...
  <div class="container marketing">
    <div class="row">
      ...
      <div class="col-md-4 text-center">
        ...
        echo "<img src='".$row3["b_image"]."' alt='img-responsive' width='100%'>";
        echo "<h2 style='text-align: center;'>".$row3['b_name']. "</h2>";
        echo "<p style='text-align: center;'>".$row3["b_info"]."</p>";
        echo "<td><a href='p1.php?id=".$row3['b_id']."' class='btn btn-default' role='button'>ดูรายละเอียด</a></td>";
        ...
        <?php //echo "<td><a href='p1.php?id=".$row3['b_id']."' class='btn btn-default' role='button'>ดูรายละเอียด</a></td>";
         ?>
