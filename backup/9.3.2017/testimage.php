...
<div class="tab-content">
  <div id="home" class="tab-pane fade in active">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="item active">
              <a href="#" data-toggle="modal" data-target=".bs-example-modal-lg">
                <img src="img/p1/1.jpg" class="img-responsive" width="100%">
              </a>

            </div>
            <div class="item">
              <a href="#" data-toggle="modal" data-target=".bs-example-modal-lg">
                <img src="img/p1/2.jpg" class="img-responsive" width="100%">
              </a>

            </div>
            <div class="item">
              <a href="#" data-toggle="modal" data-target=".bs-example-modal-lg">
                <img src="img/p1/3.jpg" class="img-responsive" width="100%">
              </a>

            </div>
            <div class="item">
              <a href="#" data-toggle="modal" data-target=".bs-example-modal-lg">
                <img src="img/p1/4.jpg" class="img-responsive" width="100%">
              </a>

            </div>
            <div class="item">
              <a href="#" data-toggle="modal" data-target=".bs-example-modal-lg">
                <img src="img/p1/5.jpg" class="img-responsive" width="100%">
              </a>

            </div>
            <div class="item">
              <a href="#" data-toggle="modal" data-target=".bs-example-modal-lg">
                <img src="img/p1/6.jpg" class="img-responsive" width="100%">
              </a>
    ...
    <div class="col-md-6">
      <h3>Farm Hug สกลนคร</h3>
      <label>ที่อยู่ : </label> ตำบล โนนหอม อำเภอเมืองสกลนคร จังหวัดสกลนคร
      <br>
      <label>รายละเอียด : </label> เป็นร้านอาหาร open air มีร้านกาแฟ ฟาร์มแกะ มีการจัดมุมต่างๆ ไว้สำหรับถ่ายภาย ให้บรรยากาศตะวันตกแบบ cowboy
      <br>
      <label>ค่าบริการ :</label> -
      <br>
      <label>จุดสังเกต :</label> หน้าฟาร์มเป็นร้านโคขุนคุณทอง
    </div>
    <div class="col-md-12">
      <br>
    </div>
      ...
      <div class="col-md-6">
        <h3>การเดินทาง</h3>
        <label>เดินทางโดยรถยนต์ส่วนตัว :</label> หากเดินทางจากท่าอากาศยานสกลนคร ให้ตรงมาตามเส้นถนนหลักประมาณ 20 กิโลเมตร อยู่ติดกับถนนใหญ่ 223 เส้น สกลนคร-นายก จุดสังเกตง่าย ๆ คือข้างหน้าฟาร์มจะเป็นร้านโคขุนคุณทอง
        <br>
        <label>เดินทางโดยรถประจำทาง/รถบัส :</label> ให้ขึ้นรถบัสสาย สกลนคร-นายก จะผ่านหน้าร้านโคขุนคุณทอง
      </div>

      <div class="col-md-6 hidden-xs">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d61031.499955394385!2d104.14117922450326!3d17.04970923115418!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x313cf3f16e6558ab%3A0x5d4a8457902ecde3!2z4Lif4Liy4Lij4LmM4Lih4Liu4Lix4LiBIEZhcm0gSHVn!5e0!3m2!1sth!2sth!4v1503286513940"
    ...
    <div class="item active">
     <img src="img/p1/1.jpg" class="img-responsive" width="100%">
      <div class="carousel-caption"  style="color:black;">
        <h1>Farm Hug</h1>
        test long text long text long text long text long text long text long text
        more long text more long text more long text more long text more long text more long text
        more long text more long text more long text more long text more long text more long text
        more long text more long text
      </div>
    </div>
    <div class="item">
      <img src="img/p1/2.jpg" class="img-responsive" width="100%">
