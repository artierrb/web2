...
//$avgscore = mysqli_query($con, "SELECT AVG(rating_score) FROM tblvote_comment INNER JOIN tbllocation ON tblvote_comment.location_id=tbllocation.location_id GROUP BY tbllocation.location_id");
...
/*$top10rating_score = mysqli_query($con, "SELECT * FROM tbllocation INNER JOIN tbllocation_image ON tbllocation.location_id=tbllocation_image.location_id
                                                         ...
                                                         GROUP BY tblvote_comment.location_id ORDER BY SUM(rating_score) AND AVG(rating_score) DESC limit 10");*/

$top10rating_score = mysqli_query($con, "SELECT * FROM tbllocation JOIN tbllocation_image ON tbllocation.location_id=tbllocation_image.location_id
                                                        JOIN tblvote_comment ON tbllocation.location_id=tblvote_comment.location_id
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown" style="font-family: 'Itim', cursive;">

          <a href="memberinfoindex.php" class="dropdown-toggle" role="button" style="font-family: 'Itim', cursive;background-color: lightgreen;"><i class="far fa-user"></i> สวัสดีคุณ <?php echo $s_login_username ;?></a>
...
<nav class="nav nav-tabs" style="color :black;">
  ...
  <h3>TOP 10 สถานที่ท่องเที่ยว</h3>
</nav>-->
<div class="container">
...
<form class="" action="index.html" method="post" >
    ...
    <div class="row col-md-12" >
      ...
      while($top10 = mysqli_fetch_array($top10rating_score)){
       ...
       ?>
      <div class="" style="background-color: powderblue;">
      <div class="col-md-3 hidden-xs  text-center">
        <div class="content-wrapper">
        <?php
        echo "<a href='p1member.php?id=".$top10['location_id']."'><img src='".$top10["location_image_file"]."' alt='img-responsive' width='100%' style='border-radius: 20px;'></a>";
        ?>
      ...
      <div class="col-md-3 hidden-xs text-center" style="background-color: #eaeaea;border-radius: 20px;border:5px solid white;margin-bottom:22px;">
        ...
        echo "<td><a href='p1member.php?id=".$top10['location_id']."' class='btn btn-success' role='button'>ดูรายละเอียด</a></td>";*/
         ?>
         <h2  style="text-align: center;line-height: 16pt; height: 32pt; overflow:hidden;"><a style="color:black;" href="p1member.php?id=<?php echo $top10['location_id'] ?>"><?php echo $top10['location_name'] ?></a></h2>
         <p style="text-align: center;line-height: 20pt; height: 39pt; overflow:hidden;"><a style="color:black;" href="p1member.php?id=<?php echo $top10['location_id'] ?>"><?php echo $top10['location_info'] ?></a></p>
         <td><a style="color:white;" href="p1member.php?id=<?php echo $top10['location_id'] ?>" class="btn btn-success" role="button">ดูรายละเอียด</a></td>
         ...
         <input style="color: yellow;" type="number" name="your_awesome_parameter" id="rating-readonly" class="rating" data-clearable="remove" value="<?php echo $top10["rating_score"]; ?>" data-readonly />
          -->
         <!--<input type="text" name="" value="<?php echo $top10["rating_score"]; ?>">-->
         <!--
         <div class="row lead">
...
<br>
    ...
    <div class="row col-md-12">
      ...
      <div class="col-md-3 col-xs-6 col-sm-3 text-center" style="background-color: #eaeaea;border-radius: 20px;border:5px solid white;">
          ...
          <?php
          echo "<a href='p1member.php?id=".$random['location_id']."'><img src='".$random["product_image_file"]."' alt='img-responsive' width='100%' style='border-radius: 20px;'></a>";
          ?>
        ...
        <?php
        echo "<a href='p1member.php?id=".$random['location_id']."'><h2 style='text-align: center; line-height: 32pt; height: 32pt; overflow:hidden;'>".$random['product_store']. "</a></h2>";
        echo "<a href='p1member.php?id=".$random['location_id']."'><p style='text-align: center; line-height: 15pt; height: 45pt; overflow:hidden;'>".$random["product_info"]."</a></p>";
        echo "<td><a href='p1member.php?id=".$random['location_id']."' class='btn btn-success' role='button'>ดูรายละเอียด</a></td>";
         ?>
         <!-- <input style="color: yellow;" type="number" name="your_awesome_parameter" id="rating-readonly" class="rating" data-clearable="remove" value="<?php echo $row4["rating_score"]; ?>" data-readonly /> -->
         <div class="row lead">
             <div style="color: orange;" id="rating-readonly" class="starrr" data-rating='<?php echo $row["rating_score"]; ?>'></div>
         </div>
      </div>
      ...
      <?php
       ...
       <div class="col-md-3 col-xs-6 col-sm-3 text-center" style="background-color: #eaeaea;border-radius: 20px;border:5px solid white;">
           ...
           <?php
           echo "<a href='p1member.php?id=".$random2['location_id']."'><img src='".$random2["service_image_file"]."' alt='img-responsive' width='100%' style='border-radius: 20px;'></a>";
           ?>
         ...
         <?php
         echo "<a href='p1member.php?id=".$random2['location_id']."'><h2 style='text-align: center; line-height: 32pt; height: 32pt; overflow:hidden;'>".$random2['service_name']. "</a></h2>";
         echo "<a href='p1member.php?id=".$random2['location_id']."'><p style='text-align: center; line-height: 15pt; height: 45pt; overflow:hidden;'>".$random2["service_info"]."</a></p>";
         echo "<td><a href='p1member.php?id=".$random2['location_id']."' class='btn btn-success' role='button'>ดูรายละเอียด</a></td>";
          ?>
          <!-- <input style="color: yellow;" type="number" name="your_awesome_parameter" id="rating-readonly" class="rating" data-clearable="remove" value="<?php echo $row4["rating_score"]; ?>" data-readonly /> -->
          <div class="row lead">
              <div style="color: orange;" id="rating-readonly" class="starrr" data-rating='<?php echo $row["rating_score"]; ?>'></div>
       ...
       <?php
        ...
        <div class="col-md-3 col-xs-6 col-sm-3 text-center" style="background-color: #eaeaea;border-radius: 20px;border:5px solid white;">
            ...
            <?php
            echo "<a href='p1member.php?id=".$random3['location_id']."'><img src='".$random3["festival_image_file"]."' alt='img-responsive' width='100%' style='border-radius: 20px;'></a>";
            ?>
          ...
          <?php
          echo "<a href='p1member.php?id=".$random3['location_id']."'><h2 style='text-align: center; line-height: 32pt; height: 32pt; overflow:hidden;'>".$random3['festival_name']. "</a></h2>";
          echo "<a href='p1member.php?id=".$random3['location_id']."'><p style='text-align: center; line-height: 15pt; height: 45pt; overflow:hidden;'>".$random3["festival_info"]."</a></p>";
          echo "<td><a href='p1member.php?id=".$random3['location_id']."' class='btn btn-success' role='button'>ดูรายละเอียด</a></td>";
           ?>
           <!-- <input style="color: yellow;" type="number" name="your_awesome_parameter" id="rating-readonly" class="rating" data-clearable="remove" value="<?php echo $row4["rating_score"]; ?>" data-readonly /> -->
           <div class="row lead">
               <div style="color: orange;" id="rating-readonly" class="starrr" data-rating='<?php echo $row["rating_score"]; ?>'></div>
        ...
        <?php
         ...
         <div class="col-md-3 col-xs-6 col-sm-3 text-center" style="background-color: #eaeaea;border-radius: 20px;border:5px solid white;">
             ...
             <?php
             echo "<a href='p1member.php?id=".$random4['location_id']."'><img src='".$random4["lodge_image_file"]."' alt='img-responsive' width='100%' style='border-radius: 20px;'></a>";
             ?>
           ...
           <?php
           echo "<a href='p1member.php?id=".$random4['location_id']."'><h2 style='text-align: center; line-height: 32pt; height: 32pt; overflow:hidden;'>".$random4['lodge_name']. "</a></h2>";
           echo "<a href='p1member.php?id=".$random4['location_id']."'><p style='text-align: center; line-height: 15pt; height: 45pt; overflow:hidden;'>".$random4["lodge_info"]."</a></p>";
           echo "<td><a href='p1member.php?id=".$random4['location_id']."' class='btn btn-success' role='button'>ดูรายละเอียด</a></td>";
            ?>
            <!-- <input style="color: yellow;" type="number" name="your_awesome_parameter" id="rating-readonly" class="rating" data-clearable="remove" value="<?php echo $row4["rating_score"]; ?>" data-readonly /> -->
            <div class="row lead">
                <div style="color: orange;" id="rating-readonly" class="starrr" data-rating='<?php echo $row["rating_score"]; ?>'></div>
