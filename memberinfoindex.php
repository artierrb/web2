  ...
  ?>
    ...
    <div class="col-md-8">
      ...
      <div>
        ...
        <div class="col-md-2">
          <p><?php echo $s_login_username; ?> <?php echo $s_login_surname; ?></p>
          <img style="border-radius: 22px;" src="img/<?php echo "$s_login_image" ?>" class="img-responsive " style="margin-top : 10px; width:100%">
        </div>
        <div class="col-md-6">



        <p>เพศ <?php echo $s_login_sex; ?></p>
        <!--<p>เกิดเมื่อ <?php echo $s_login_bdate; ?></p>-->
        <p>อีเมล <?php echo $s_login_email; ?></p>
        ...
        <div class="col-md-4">
          <footer id="myFooter" class="text-left">
            <div class="social-networks">
              <p>Social Networks</p>
              <a href="<?php echo $s_login_fb = $row_user['member_facebook']; ?>" class="facebook"><i class="fa fa-facebook-official"> </i> </a>
              <a href="<?php echo $s_login_tw = $row_user['member_twitter']; ?>" class="twitter"><i class="fa fa-twitter"> </i> </a>
              <a href="<?php echo $s_login_ig = $row_user['member_instagram']; ?>" class="google"><i class="fab fa-instagram"> </i> </a>
      ...
      <div class="col-md-12">
        <nav class="text-center">
         <ul class="pagination">
         <li>
         <a href="memberinfoindex.php?page=1" aria-label="Previous">
         <span aria-hidden="true">&laquo;</span>
         </a>
         </li>
         <?php for($i=1;$i<=$total_page;$i++){ ?>
         <li><a href="memberinfoindex.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
         <?php } ?>
         <li>
         <a href="memberinfoindex.php?page=<?php echo $total_page;?>" aria-label="Next">
