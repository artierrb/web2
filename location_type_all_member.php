   ...
   ?>
     ...
     <div class="col-md-12">
       <nav class="text-center">
        <ul class="pagination">
        <li>
        <a href="location_type_all_member.php?page=1" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
        </a>
        </li>
        <?php for($i=1;$i<=$total_page;$i++){ ?>
        <li><a href="location_type_all_member.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
        <?php } ?>
        <li>
        <a href="location_type_all_member.php?page=<?php echo $total_page;?>" aria-label="Next">
