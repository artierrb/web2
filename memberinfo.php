...
<div class="container">
  ...
  ?>
    ...
    <div class="page-header">
      <h1>ข้อมูลส่วนตัว / Personal Information</h1>
    </div> -->
    ...
    <div class="col-md-8">
      ...
      <div class="input-group date" data-provide="datepicker" data-date-language="th-th">
          <input type="text" class="form-control" style="background-color : white;" class="form-control" name="bdate" value="<?php echo "$s_login_bdate" ?>" disabled>
