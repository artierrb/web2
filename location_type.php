  ...
  <div class="row col-md-12">
    <div class="page-header">
      <h1><?php echo $id_type ?> <!--<div class="btn-group right">
        ...
        <div class="col-md-3 text-center" style="background-color: #eaeaea;  margin-bottom:5px; margin-top:5px;border-radius: 22px; border-color: white; border:5px solid white;">
          <p></p>
          <a href="p1.php?id=<?php echo $row["location_id"]; ?>"><img src="<?php echo $row["location_image_file"]; ?>" alt="img-responsive" width="100%"></a>
          <link rel="stylesheet" >
          <a href="p1.php?id=<?php echo $row["location_id"]; ?>"><h2 style="text-align: center; line-height: 32pt; height: 32pt; overflow:hidden;"><?php echo $row['location_name'] ?> </h2></a>
          ...
          <p style="border: 2px solid #cccccc;border-radius: 12px;">โดย <a href="memberloginform.php"><?php echo $row["member_name"]; ?> <?php echo $row["member_surname"]; ?></a> </p>
    ...
    <div class="col-md-12">
      <nav class="text-center">
       <ul class="pagination">
       <li>
       <a href="location_type.php?id=<?php echo $id_type?>&page=1" aria-label="Previous">
       <span aria-hidden="true">&laquo;</span>
       </a>
       </li>
       <?php for($i=1;$i<=$total_page;$i++){ ?>
       <li><a href="location_type.php?id=<?php echo $id_type?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
       <?php } ?>
       <li>
       <a href="location_type.php?id=<?php echo $id_type?>&page=<?php echo $total_page;?>" aria-label="Next">
