...
$reportbyname = $_GET['reportbyname'];
$reportbysurname = $_GET['reportbysurname'];
$commentid = $_GET['commentid'];

print_r($_POST);
$report_sql = "INSERT INTO tblreport_comment(vote_comment_id,location_id,member_id,by_member_name,by_member_surname,reportcomment_message) VALUES ((SELECT vote_comment_id FROM tblvote_comment WHERE vote_comment_id = $commentid),(SELECT location_id FROM tbllocation WHERE location_id = $id),
              (SELECT member_id FROM tblmember WHERE member_id = $member_id),(SELECT member_name FROM tblmember WHERE member_id = $reportbyname)
              ,(SELECT member_surname FROM tblmember WHERE member_id = $reportbysurname),'".$_POST["reportcomment_message"]."')";
