...
$locationmem_info_query ="SELECT * FROM tbllocation WHERE member_id='$id_member' ORDER BY location_id DESC limit {$start} , {$perpage} ";
$locationmemberinfo_result = mysqli_query($con, $locationmem_info_query);
$i = 1;

$mem_info_query_view ="SELECT * FROM tblmember WHERE member_id='$id_member'";
$memberinfo_result_view = mysqli_query($con, $mem_info_query_view);
$memberinfo_result_fetch = mysqli_fetch_array($memberinfo_result_view, MYSQLI_ASSOC);
...
<div class="container">
  ...
  ?>
    ...
    <div class="col-md-4">
      <img src="img/<?php echo "$s_login_image" ?>" class="img-responsive center-block" style="margin-top : 10px; width:50%;border-radius:22px">
      <br>
    ...
    <div class="col-md-8">
      ...
      <div>
        ...
        <div class="col-md-2">
          <p><?php echo $memberinfo_result_fetch['member_name']; ?> <?php echo $memberinfo_result_fetch['member_surname']; ?></p>
          <img style="border-radius: 22px;" src="img/<?php echo $memberinfo_result_fetch['member_image']; ?>" class="img-responsive " style="margin-top : 10px; width:100%">
        </div>
        <div class="col-md-6">



        <p>เพศ <?php echo $memberinfo_result_fetch['member_sex']; ?></p>
        <p>อีเมล <?php echo $memberinfo_result_fetch['member_email']; ?></p>


        </div>
        <div class="col-md-4">
          <footer id="myFooter" class="text-left">
            <div class="social-networks">
              <p>Social Networks</p>
              <a href="<?php echo $memberinfo_result_fetch['member_facebook']; ?>" class="facebook"><i class="fa fa-facebook-official"> </i> </a>
              <a href="<?php echo $memberinfo_result_fetch['member_twitter']; ?>" class="twitter"><i class="fa fa-twitter"> </i> </a>
              <a href="<?php echo $memberinfo_result_fetch['member_instagram']; ?>" class="google"><i class="fab fa-instagram"> </i> </a>
        ...
        <h3>ประวัติการเพิ่มบทความล่าสุด</h3>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td scope="row"><a href="p1member.php?id=<?php echo $locationmemberinfo["location_id"]; ?>"><?php echo $locationmemberinfo["location_name"]; ?></></td>
                <td scope="row"><a href="p1member.php?id=<?php echo $locationmemberinfo["location_id"]; ?>"><?php echo $locationmemberinfo["location_type"]; ?></></td>
              <td scope="row"><a href="p1member.php?id=<?php echo $locationmemberinfo["location_id"]; ?>"><?php echo $locationmemberinfo["location_date"]; ?></td>
        ...
        <?php
        $sql2 = "SELECT * FROM tbllocation WHERE member_id='$id_member' ORDER BY location_id DESC";
      ...
      <div class="col-md-12">
        <nav class="text-center">
         <ul class="pagination">
         <li>
         <a href="view_history.php?id=<?php echo $id_member; ?>&page=1" aria-label="Previous">
         <span aria-hidden="true">&laquo;</span>
         </a>
         </li>
         <?php for($i=1;$i<=$total_page;$i++){ ?>
         <li><a href="view_history.php?id=<?php echo $id_member; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
         <?php } ?>
         <li>
         <a href="view_history.php?id=<?php echo $id_member; ?>&page=<?php echo $total_page;?>" aria-label="Next">
