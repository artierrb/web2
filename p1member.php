...
<div class="tab-content">
  <div id="home" class="tab-pane fade in active">
    ...
    <div class="text-right">
      <button type="button" class="btn btn-danger btn-lg" data-toggle="modal" data-target="#myModal" name="button">
        <i class="fas fa-exclamation-circle"></i> แจ้งลบบทความนี้
      </button>
    </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">แจ้งลบบทความนี้</h4>
        </div>



        <form class="" action="report_location.php?id=<?php echo $id ?>&member=<?php echo $locationmemberinfo_result['member_id'] ?>&reportbyname=<?php echo $_SESSION['member_id']; ?>&reportbysurname=<?php echo $_SESSION['member_id']; ?>" method="post">
        <div class="modal-body">
          <p>ข้อความที่ต้องการแจ้ง เกี่ยวกับบทความ <?php echo $locationinfo["location_name"];?></p>
          <textarea class="form-control" rows="5" name="report_message"></textarea>
          <br>
...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      ...
      echo "<form action='savecomment.php?id=".$locationinfo['location_id']."' method='post'>";
      ?>
        ...
        <div class="row" id="post-review-box" >
                  <div class="col-md-12">
                      ...
                      <form accept-charset="UTF-8" action="savecomment.php" method="post">
                          ...
                          <fieldset class="rating" style="font-size: 36px;float: left;margin-right: 25px; text-center">



                          <fieldset class="rating" style="font-size: 36px;float: left;">
                          ...
                          <textarea class="form-control animated" disabled cols="50" id="myTextarea" name="comment" placeholder="แสดงความคิดเห็นของคุณที่นี่..." rows="5"></textarea>
                          <name "locateid" value="$id">
                          <div class="text-right">
                            <br>
...
<div class="container">
  <div class="row col-md-12">
    ...
    <div class="col-md-12" style="background-color: #eaeaea;border-radius: 20px;border:5px solid white;">
      <table>
        <td>ความคิดเห็นโดย  <span class="label label-default"><?php echo $ratingscore["member_name"]; ?> <?php echo $ratingscore["member_surname"]; ?></span></td>
        <br>

        <td><span class="label label-warning"><a data-toggle="modal" data-target="#myModal<?php echo $ratingscore["member_id"]; ?>" style="color:white;">แจ้งลบความคิดเห็นนี้</a></span></td>
        <?php if ($ratingscore["member_id"]=="$session_login_id"): ?>
        <td><span class="label label-success"><a data-toggle="modal" data-target="#myModaledit<?php echo $ratingscore["member_id"]; ?>" style="color:white;">แก้ไขความคิดเห็น</a></span></td>
        <?php else: ?>
        <?php endif; ?>
      </table>

      <div class="modal fade" id="myModal<?php echo $ratingscore["member_id"]; ?>" role="dialog">
      <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">แจ้งลบความคิดเห็นนี้</h4>
          </div>

          <form class="" action="report_comment.php?id=<?php echo $id ?>&member=<?php echo $ratingscore['member_id'] ?>&reportbyname=<?php echo $_SESSION['member_id']; ?>&reportbysurname=<?php echo $_SESSION['member_id']; ?>&commentid=<?php echo $ratingscore["vote_comment_id"]; ?>" method="post">
          <div class="modal-body">
            <p>ข้อความที่ต้องการแจ้ง เกี่ยวกับความคิดเห็นของ <?php echo $ratingscore["member_name"];?> <?php echo $ratingscore["member_surname"];?></p>
            <textarea class="form-control" rows="5" name="reportcomment_message"></textarea>
            <br>
            <div class="text-center">
    ...
    <div class="modal fade" id="myModaledit<?php echo $ratingscore["member_id"]; ?>" role="dialog">
    <div class="modal-dialog">
      <!-- Modal content-->
      <div class="modal-content">


        <form class="" action="edit_comment.php?id=<?php echo $id ?>&member=<?php echo $locationmemberinfo_result['member_id'] ?>&commentid=<?php echo $ratingscore["vote_comment_id"]; ?>" method="post">
        <div class="modal-body">
          <p>แก้ไขความคิดเห็นของคุณ <?php echo $ratingscore["member_name"];?> <?php echo $ratingscore["member_surname"];?></p>
          <textarea class="form-control" rows="5" name="edit_message"><?php echo $ratingscore["rating_comment"] ?></textarea>
          <br>
