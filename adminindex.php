...
$locationmem_info_query ="SELECT * FROM tblreport_location JOIN tblmember ON tblreport_location.member_id=tblmember.member_id JOIN tbllocation ON tblreport_location.location_id=tbllocation.location_id
                           GROUP BY tbllocation.location_name ORDER BY report_id DESC limit {$start} , {$perpage} ";
  ...
  ?>
    ...
    <div class="col-md-4">
      ...
      <div class="list-group hidden-xs">
        <a href="adminindex.php" class="list-group-item" style="color :black">
          <i class="far fa-bookmark" aria-hidden="true"></i> รายงานแจ้งลบบทความ
        </a>
        <a href="admincomment.php" class="list-group-item" style="color :black"><i class="far fa-comment" aria-hidden="true"></i> รายงานแจ้งลบความคิดเห็น</a>
    ...
    <div class="col-md-8">
      <div class="page-header">
        <h1><i class="far fa-bookmark" aria-hidden="true"></i> รายงานแจ้งลบบทความ </h1>
      </div>
      <div>
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td scope="row">
                <button type="button" class="btn btn-info" name="button" onclick="window.location='adminindex_info.php?id=<?php echo $locationmemberinfo["location_id"] ?>'">ดูข้อมูล</button>
            ...
            <div class="modal fade" id="myModal<?php echo $locationmemberinfo["location_id"];?>" role="dialog">
        ...
        <?php
        $sql2 = "SELECT * FROM tblreport_location ORDER BY report_id DESC";
      ...
      <div class="col-md-12">
        <nav class="text-center">
         <ul class="pagination">
         <li>
         <a href="adminindex.php?page=1" aria-label="Previous">
         <span aria-hidden="true">&laquo;</span>
         </a>
         </li>
         <?php for($i=1;$i<=$total_page;$i++){ ?>
         <li><a href="adminindex.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
         <?php } ?>
         <li>
         <a href="adminindex.php?page=<?php echo $total_page;?>" aria-label="Next">
